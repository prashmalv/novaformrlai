...
REM  Version: 1.15 — Panel height for area calc only; first-import AV fix (July 2026)
REM  Developed by RLAI (rightleft.ai)
REM
REM  What's new in v1.15:
...
REM    - DXF parser: any floor prefix (1F, 2F, TF, RF, BF, LG, PH, B1-B9).
REM
...
echo.
echo  ====================================================
echo   Installation Complete!  ^|  NovoForm v1.15
echo.
