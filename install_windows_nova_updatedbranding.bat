...
REM  Version: 1.7 — Parser Fixes: L-COL, R-COL, IC Corners (June 2026)
REM  Developed by RLAI (rightleft.ai)
REM
REM  What's new in v1.7:
...
echo.
echo  ====================================================
echo   Installation Complete!  ^|  NovoForm v1.7
echo.
