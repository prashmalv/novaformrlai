...
title NovoForm v1.27 Installer

echo.
echo  ====================================================
echo   NovoForm — Formwork Analysis and BOQ Generator
echo   Version 1.27  ^|  Nova Formworks Pvt. Ltd.
...
powershell -NoProfile -Command ^
    "$ws = New-Object -ComObject WScript.Shell; ^
     ...
     $s.Description     = 'NovoForm BOQ Generator — Nova Formworks v1.27'; ^
     $s.Save()" >nul 2>&1
...
echo.
echo  ====================================================
echo   Installation Complete!  ^|  NovoForm v1.27
echo.
