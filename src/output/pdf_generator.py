...
def _boq_element_table(group: dict, num_sets: int = 1, dxf_doc=None) -> list:
    ...
    if el.is_column:
        ...
        acc, highlight_status = compute_column_accessories(el.length_mm, el.width_mm, height_mm, el.label, el.polygon_pts)
        items.append(_col_accessories_table(acc, no_sets,'COLUMN ACCESSORIES', highlight_status))
        #items.extend(_col_accessories_table(acc, no_sets,'COLUMN ACCESSORIES', highlight_status))
    ...
    if el.is_wall:
        ...
        #items.extend(_col_accessories_table(acc, no_sets, 'SHEARWALL ACCESSORIES', highlight_status))

    items.append(Spacer(1, 3*mm))
    return items

# def _col_accessories_table(
#     acc,
#     no_sets: int,
#     col,
...
#     """
#     Compact accessories table appended below each element's panel table.
#     """

#     print("this is col accessories call")
#     print("highlight_status =", highlight_status)

#     _ACC_PURPLE = colors.HexColor('#5a1a3e')
...
#     # ---------------------------------------------------------
#     wallers_per_row = (
#         acc.total_wallers // acc.num_rows
#         if acc.num_rows else 0
#     )

#     tierods_per_row = (
#         acc.total_tierods // acc.num_rows
#         if acc.num_rows else 0
#     )

#     rows_str = (
#         f"Waller rows: {acc.num_rows}  |  "
#         f"heights: {acc.positions_str}  |  "
#         f"per row: {wallers_per_row} wallers + "
#         f"{tierods_per_row} tierods"
#     )

#     # ---------------------------------------------------------
#     # Main accessories header
#     # ---------------------------------------------------------
...
#             'nos',
#             '',
#             acc.total_tierods * no_sets
#         ],
#         [
#             'Anchor Nut',
#             acc.total_anchor_nuts,
#             'nos',
#             '',
#             acc.total_anchor_nuts * no_sets
#         ],
#     ]
...
#         warning_header = [
#             Paragraph(
#                 "■ Need to manually verify accessories",
#                 ParagraphStyle(
#                     'accessory_warning',
#                     fontSize=7.5,
#                     fontName='Helvetica-BoldOblique',
...
#         # Add warning row at the beginning
#         rows.insert(0, warning_header)

#         warning_row = 0
#         accessory_header_row = 1
#         column_header_row = 2
#         data_start_row = 3
...
#         (
#             'SPAN',
#             (0, accessory_header_row),
#             (-1, accessory_header_row)
#         ),
...
#             ),
#         ])
#     print("---- ACCESSORY DEBUG ----")
#     print("col =", col)
#     print("highlight_status =", highlight_status)
#     print("no_sets =", no_sets)
#     print("num_rows =", acc.num_rows)
#     print("total_wallers =", acc.total_wallers)
#     print("total_tierods =", acc.total_tierods)
#     print("total_anchor_nuts =", acc.total_anchor_nuts)
#     print("rows =", rows)
#     print("cmds =", cmds)
#     print("-------------------------")
#     print("rows before Table =", rows)
...
def _col_accessories_table( acc, no_sets: int, col,
                highlight_status=False) -> Table:
    """
    Compact accessories table appended below each element's panel table.
    """
    ...
    if highlight_status:
        ...
        # 0 = warning, 1 = accessories header, 2 = column header, 3-5 = data
        rows = [warning_header, hdr_note, col_hdr, *data_rows]
        ...
        # 0 = accessories header, 1 = column header, 2-4 = data
        rows = [hdr_note, col_hdr, *data_rows ]
    ...
    cmds = [
        # Main accessories header
        ('SPAN',  (0, accessory_header_row), (-1, accessory_header_row)),

        ('BACKGROUND', (0, accessory_header_row), (-1, accessory_header_row), header_bg),

        ('TOPPADDING', (0, accessory_header_row), (-1, accessory_header_row), 3),

        ('BOTTOMPADDING', (0, accessory_header_row), (-1, accessory_header_row),3),

        ('LEFTPADDING', (0, accessory_header_row), (-1, accessory_header_row), 4),

        # Column header
        ('BACKGROUND', (0, column_header_row),(-1, column_header_row),NOVA_NAVY),

        ('TEXTCOLOR', (0, column_header_row),(-1, column_header_row),NOVA_WHITE),

        ('FONTNAME',(0, column_header_row),(-1, column_header_row),'Helvetica-Bold'),

        ('FONTSIZE', (0, column_header_row), (-1, column_header_row), 7),

        ('ALIGN',(0, column_header_row),(-1, column_header_row),'CENTER'),

        ('VALIGN',(0, column_header_row), (-1, column_header_row),'MIDDLE'),

        ('TOPPADDING', (0, column_header_row), (-1, column_header_row),  2),

        ('BOTTOMPADDING', (0, column_header_row), (-1, column_header_row), 2),

        # Data rows
        ('BACKGROUND', (0, data_start_row),(-1, data_end_row), _ACC_BG),

        ('FONTNAME', (0, data_start_row), (-1, data_end_row),'Helvetica'),

        ('FONTSIZE', (0, data_start_row), (-1, data_end_row),  7.5),

        ('ALIGN', (1, data_start_row), (-1, data_end_row), 'CENTER'),

        ('ALIGN', (0, data_start_row), (0, data_end_row), 'LEFT'),

        ('TOPPADDING', (0, data_start_row), (-1, data_end_row), 2),

        ('BOTTOMPADDING', (0, data_start_row), (-1, data_end_row), 2),

        # No. of elements column
        ('SPAN', (3, data_start_row), (3, data_end_row)),

        ('VALIGN', (3, data_start_row),(3, data_end_row), 'MIDDLE'),
    ...
    # Warning row has its own styling
    if highlight_status:
        cmds.extend([
            ('SPAN',
             (0, warning_row),
...
# def _col_accessories_table(acc, no_sets: int, col, highlight_status = False) -> list:
#     """
